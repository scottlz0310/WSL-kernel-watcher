...
class TestConfigManager:
    ...
    def test_create_default_config(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert config_data["check_interval_minutes"] == expected_config.check_interval_minutes
            assert config_data["repository_url"] == expected_config.repository_url
            assert config_data["enable_build_action"] == expected_config.enable_build_action
            assert config_data["notification_enabled"] == expected_config.notification_enabled
