...
class TestGitHubAPIClient:
    ...
    def test_is_prerelease_with_prerelease_flag(self):
        ...
        release_data = {"tag_name": "linux-msft-wsl-5.15.90.1", "prerelease": True}
        assert self.client.is_prerelease(release_data) is True

    def test_is_prerelease_with_rc_tag(self):
        """RCタグを含む場合のテスト"""
        release_data = {"tag_name": "linux-msft-wsl-5.15.90.1-rc1", "prerelease": False}
        assert self.client.is_prerelease(release_data) is True
    ...
    def test_is_not_prerelease_stable(self):
        """安定版の場合のテスト"""
        release_data = {"tag_name": "linux-msft-wsl-5.15.90.1", "prerelease": False}
