...
from src.github_watcher import Release
from src.main import WSLKernelWatcher, setup_logging
...
class TestWSLKernelWatcher:
    ...
    def setup(self):
        ...
        with (
            ...
            patch("src.main.GitHubWatcher") as mock_watcher_class,
            patch("src.main.DockerNotifier") as mock_notifier_class,
    ...
    @patch("src.main.GitHubWatcher")
    @patch("src.main.DockerNotifier")
    @patch("src.main.setup_logging")
    def test_init(
        self,
        mock_setup_logging,
