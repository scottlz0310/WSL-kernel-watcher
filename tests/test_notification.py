...
from src.notification import NotificationManager, NotificationContent
...
class TestNotificationManager:
    ...
    def test_init_with_windows_toasts_available(self, mock_config, mock_windows_toaster):
    ...
    def test_init_with_windows_toasts_error(self, mock_config):
        ...
        with patch('src.notification.WindowsToaster', side_effect=Exception("初期化エラー")):
            manager = NotificationManager(mock_config)
    ...
    @patch('src.notification.WINDOWS_TOASTS_AVAILABLE', True)
    def test_is_notification_supported_disabled(self, mock_config, mock_windows_toaster):
        """通知機能サポート確認テスト（無効）"""
    ...
    @patch('src.notification.WINDOWS_TOASTS_AVAILABLE', True)
    def test_show_update_notification_success(self, mock_config, mock_windows_toaster, mock_toast):
        """更新通知表示成功テスト"""
        mock_config.notification_enabled = True
        manager = NotificationManager(mock_config)
    ...
    @patch('src.notification.WINDOWS_TOASTS_AVAILABLE', True)
    def test_show_update_notification_not_supported(self, mock_config, mock_windows_toaster):
        """通知機能が無効な場合のテスト"""
        mock_config.notification_enabled = False
        manager = NotificationManager(mock_config)
    ...
    @patch('src.notification.WINDOWS_TOASTS_AVAILABLE', True)
    def test_show_update_notification_error(self, mock_config, mock_windows_toaster, mock_toast):
        """通知表示エラーテスト"""
        mock_config.notification_enabled = True
    ...
    @patch('src.notification.WINDOWS_TOASTS_AVAILABLE', True)
    def test_notification_click_without_build_action(self, mock_config, mock_windows_toaster):
    ...
    @patch('src.notification.WINDOWS_TOASTS_AVAILABLE', True)
    def test_notification_click_with_build_action_success(self, mock_config, mock_wsl_utils, mock_windows_toaster):
    ...
    @patch('src.notification.WINDOWS_TOASTS_AVAILABLE', True)
    def test_notification_click_with_build_action_failure(self, mock_config, mock_wsl_utils, mock_windows_toaster):
    ...
    @patch('src.notification.WINDOWS_TOASTS_AVAILABLE', True)
    def test_notification_click_without_wsl_utils(self, mock_config, mock_windows_toaster):
    ...
    @patch('src.notification.WINDOWS_TOASTS_AVAILABLE', True)
    def test_show_info_notification(self, mock_config, mock_windows_toaster, mock_toast):
        """情報通知表示テスト"""
        mock_config.notification_enabled = True
        manager = NotificationManager(mock_config)
    ...
    @patch('src.notification.WINDOWS_TOASTS_AVAILABLE', True)
    def test_show_error_notification(self, mock_config, mock_windows_toaster, mock_toast):
        """エラー通知表示テスト"""
        mock_config.notification_enabled = True
        manager = NotificationManager(mock_config)
...
class TestNotificationManagerIntegration:
    ...
    @patch('src.notification.WINDOWS_TOASTS_AVAILABLE', True)
    def test_full_notification_flow_with_click(self, mock_config, mock_wsl_utils, mock_windows_toaster, mock_toast):
